...
for(int i=0;i<list.size();i++){
   %><hr><p>이름 : <%=list.get(i).getName() %> , 나이: <%=list.get(i).getAge() %>, 주소: <%=list.get(i).getAddress() %>, 
   day 가격: <%=list.get(i).getPrice_day() %>, Night 가격: <%=list.get(i).getPrice_night() %></p>
