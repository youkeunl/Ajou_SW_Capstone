...
dto.setPetSitter_ID("priends");
dto.setPetSitter_Pwd("1234");
dto.setName("선호찡");
dto.setSex("남자");
dto.setJob("학생");
dto.setCareer(0);
dto.setCertification("ok");
dto.setAge(25);
dto.setCharacter("잘생김");
dto.setAddress("경기도 서천마을");
dto.setPrice_day(10000);
dto.setPrice_night(30000);

int i = dao.insertOne(dto);
