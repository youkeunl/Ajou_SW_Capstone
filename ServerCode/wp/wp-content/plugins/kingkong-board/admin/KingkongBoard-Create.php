...
?>
            ...
            <tr>
              ...
              <td>
                <table>
                  ...
                  <tr>
                    <td colspan="2">
                      <input type="checkbox" name="kkb_board_captcha" value="T"> <?php echo __('게시글 자동글 방지(google reCAPTCHA)를 사용합니다.', 'kingkongboard');?>
                    <div class="description-container">
                  ...
                  <tr>
                    <td colspan="2">
                      <input type="checkbox" name="kkb_comment_captcha" value="T"> <?php echo __('댓글 자동글 방지(google reCAPTCHA)를 사용합니다.', 'kingkongboard');?>
                    <div class="description-container">
            ...
            <tr>
              ...
              <td>
                <input type="checkbox" name="kkb_comment_html_use" value="T"><?php _e('댓글에 HTML 사용을 가능하게 합니다.', 'kingkongboard');?>
                <div class="description-container">
            ...
            <tr>
              ...
              <td>
                <input type="checkbox" name="kkb_auto_link" value="T"> <?php echo __('본문에 URL 기입시 자동으로 하이퍼링크를 붙입니다.', 'kingkongboard');?>
                <div class="description-container">
                  <span class="description"><?php echo __('http 또는 https 링크 기입시 자동으로 해당 경로로 링크를 연결 합니다.', 'kingkongboard');?></span>
                </div>
                <input type="checkbox" name="kkb_comment_auto_link" value="T"> <?php echo __('댓글에 URL 기입시 자동으로 하이퍼링크를 붙입니다.', 'kingkongboard');?>
                <div class="description-container">
                  <span class="description"><?php echo __('http 또는 https 링크 기입시 자동으로 해당 경로로 링크를 연결 합니다.', 'kingkongboard');?></span>
                </div>                  
              </td>
