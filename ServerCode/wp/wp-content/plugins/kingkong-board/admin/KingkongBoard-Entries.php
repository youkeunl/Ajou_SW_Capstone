...
?>
    ...
    <div style="float:right; margin-right:5px; padding-bottom:5px"><?php echo __('등록된 총 글 수', 'kingkongboard');?> : <span style="background:#616161; color:#fff; border-radius:10px; padding:0 5px"><?php echo $KKB_List->getCount($board_id, 'basic')+$KKB_List->getCount($board_id, 'notice');?></span></div>
